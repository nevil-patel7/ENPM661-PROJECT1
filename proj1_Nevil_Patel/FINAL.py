...
#To check the solvability of matrix
...
print(StartNode)
New_S_Node = copy.deepcopy(StartNode)
print(New_S_Node)
reemovNestings(New_S_Node,Merged_Nodes_S)
print(Merged_Nodes_S)
Check = Check_Puzzle(Merged_Nodes_S)
...
if Check == True:
    ...
    with open('nodePath.txt', 'w') as fh:
            for x in range(0,len(Merged_Generate_Path),9):
                ...
                fh.write(str(Merged_Generate_Path[x+3]) + ' ')
                fh.write(str(Merged_Generate_Path[x+6]) + ' ')
                fh.write(str(Merged_Generate_Path[x+1]) + ' ')
                fh.write(str(Merged_Generate_Path[x+4]) + ' ')
                fh.write(str(Merged_Generate_Path[x+7]) + ' ')
                fh.write(str(Merged_Generate_Path[x+2]) + ' ')
                fh.write(str(Merged_Generate_Path[x+5]) + ' ')
                fh.write(str(Merged_Generate_Path[x+8]) + ' ')
                fh.write("\n")
